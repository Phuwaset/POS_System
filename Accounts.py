...
# GUI สำหรับจัดการระบบของร้านกาแฟ (Coffee Management System) 
# ซึ่งใช้ Tkinter และ SQLite ในการจัดการฐานข้อมูล มีฟังก์ชันสำหรับการแสดงข้อมูล, 
# อัพเกรดบัญชี, เพิ่ม, ลบ และอัพเดตข้อมูลของ Guest, Employee, และ Admin 
# โดยมีการแสดงผลเป็นตารางข้อมูลในหน้า UI
